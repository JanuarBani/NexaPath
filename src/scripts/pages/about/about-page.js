...
<div id="about-section" class="w-full flex flex-col space-y-12 px-6 md:px-12 lg:px-20 py-16">
  ...
  <section aria-labelledby="about-heading"
           class="neon-box bg-gradient-to-br from-white via-blue-50 to-blue-100 dark:from-gray-900 dark:via-gray-800 dark:to-gray-700 py-14 px-8 rounded-3xl transition-colors duration-500"
  >
    <header class="max-w-4xl mx-auto text-center">
      <h2 id="about-heading" class="text-5xl font-extrabold text-blue-700 dark:text-blue-300 mb-6 tracking-tight">
        Tentang Website Ini - NexaPath – Temukan Jurusan & Karier Impianmu
      </h2>
...
<section aria-labelledby="techstack-heading"
         class="neon-box bg-gray-50 dark:bg-gray-800 rounded-3xl py-14 px-10 max-w-4xl mx-auto shadow-md"
>
  ...
  <section aria-label="Gambar Karier Impian"
           class="neon-box max-w-4xl mx-auto rounded-3xl overflow-hidden shadow-lg hover:shadow-2xl transition-shadow duration-500">
    <img src="/images/karir.jpg" alt="Karier Impian" class="w-full h-auto object-cover" />
  </section>

  <!-- Fitur Utama -->
<section aria-labelledby="features-heading"
         class="neon-box bg-white dark:bg-gray-900 rounded-3xl py-14 px-10 shadow-md max-w-5xl mx-auto"
    >
...
<section aria-labelledby="goal-heading"
         class="neon-box bg-gray-100 dark:bg-gray-800 py-14 px-8 rounded-3xl max-w-5xl mx-auto">
...
<section aria-labelledby="stats-heading"
         class="neon-box bg-blue-50 dark:bg-gray-900 py-12 px-10 rounded-3xl max-w-5xl mx-auto text-center">
...
<section class="text-center py-12">
  <a href="#/karier"
     class="neon-btn inline-block bg-blue-600 hover:bg-blue-700 text-white font-semibold py-3 px-6 rounded-full transition duration-300">
